            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-lg mb-4">
                  Scale & Sell is a modern marketplace designed to facilitate
                  the buying and selling of established businesses. We bring
                  together entrepreneurs ready to pass the torch and investors
                  seeking proven opportunities.
                </p>
                <p className="text-lg mb-4">
                  Our platform provides the tools, security, and transparency
                  needed for successful business transactions. From listing to
                  closing, we ensure every step is safe, clear, and
                  professional.
                </p>
                <p className="text-lg">
                  With built-in escrow, secure messaging, and digital contracts,
                  we make it easier than ever to find, evaluate, and acquire
